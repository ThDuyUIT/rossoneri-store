...
abstract class StringValidator {
  ...
  // bool isMatch(String value, String matchValue);
}

abstract class CompareStringValidator {
  bool isMatch(String value, String matchValue);
}
...
class NumberValidator extends RegexValidator {
  NumberValidator() : super(regexSource: '^[0-9]+\$');
}

class MinLengthNumberValidator extends NumberValidator {
  MinLengthNumberValidator(this.minLength);
...
class MatchVerifyPasswordValidator extends CompareStringValidator {
  final String value;
  final String matchValue;

  MatchVerifyPasswordValidator({required this.value, required this.matchValue});
